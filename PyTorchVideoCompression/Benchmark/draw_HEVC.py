...
def drawhevc(hclass):
    ...
    if hclass == 'B':
        ...
        bpp, psnr = [0.281287, 0.15198, 0.095345, 0.054663], [36.093717, 35.249646, 34.495771, 33.352303]
        ...
        bpp, psnr, msssim = [0.251340112304687, 0.114954760742187, 0.0600326822916666, 0.0351277750651041], [35.6670097710266, 34.4030844090323, 33.2172471219672, 32.1359572232844], [0.972090578181901, 0.96565135821819, 0.957313066103425, 0.94749255429957]
        HM, = plt.plot(bpp, psnr, "r--v", linewidth=LineWidth, label='HM')

        bpp, psnr, msssim = [0.189708520507812, 0.0804945882161458, 0.0423038167317708, 0.0243409505208333], [35.6519601752973, 34.4253560065264, 33.3251352239511, 32.2012954952894], [0.971886126870312, 0.965818908650435, 0.958006844631428, 0.947446012049659]
        ...
        bpp, psnr = [0.415154, 0.266551, 0.190092, 0.118329], [34.761444, 33.332477, 32.431844, 30.534839]
        C2F, = plt.plot(bpp, psnr, "y-o", color="indigo", linewidth=LineWidth, label='C2F')
        ...
        bpp, psnr, msssim = [0.395451633327609, 0.233026324261675, 0.139801790006868, 0.0869840852506868], [35.2004277499295, 33.3776422865319, 31.5954333021148, 30.0681941822946], [0.983137322154396, 0.976583547685491, 0.966985638804443, 0.955445799590982]
        HM, = plt.plot(bpp, psnr, "r--v", linewidth=LineWidth, label='HM')

        bpp, psnr, msssim = [0.316903813959478, 0.177790339543269, 0.102977120535714, 0.0618710293612637], [35.2650968922807, 33.4511376705404, 31.7276604485434, 30.1223210792241], [0.983316846791006, 0.97694506449205, 0.967863422310179, 0.955685704405203]
        VTM, = plt.plot(bpp, psnr, "b--v", linewidth=LineWidth, label='VTM')
    elif hclass == 'D':
        ...
        bpp, psnr = [0.427241, 0.284719, 0.206169, 0.127433], [35.368519, 33.777724, 32.738523, 30.657859]
        C2F, = plt.plot(bpp, psnr, "y-o", color="indigo", linewidth=LineWidth, label='C2F')
        ...
        bpp, psnr, msssim = [0.421774631076388, 0.255772569444444, 0.154388020833333, 0.0965383572048611], [35.3083714785042, 33.3113967817325, 31.3573852056078, 29.7119945296492], [0.986564271808116, 0.98065750923472, 0.971165501797031, 0.959300524845527]
        HM, = plt.plot(bpp, psnr, "r--v", linewidth=LineWidth, label='HM')

        bpp, psnr, msssim = [0.32873046875, 0.189267306857638, 0.111019151475694, 0.0671408420138889], [35.169782916185, 33.1212890535321, 31.2001312091912, 29.4476914202527], [0.986346814339849, 0.98014274736633, 0.97073237988727, 0.957319993641866]
        VTM, = plt.plot(bpp, psnr, "b--v", linewidth=LineWidth, label='VTM')
    elif hclass == 'E':
        ...
        bpp, psnr = [0.080007, 0.042101, 0.025452, 0.016367], [40.521923, 39.540093, 38.501088, 37.267061]
        C2F, = plt.plot(bpp, psnr, "y-o", color="indigo", linewidth=LineWidth, label='C2F')
        ...
        bpp, psnr, msssim = [0.055168649, 0.0265538293087121, 0.0150178148674242, 0.00944111032196969], [39.49582704, 38.3563381408218, 37.1566231697589, 35.9742170858723], [0.985909003, 0.983362631774598, 0.97982818499309, 0.975380472078818]
        HM, = plt.plot(bpp, psnr, "r--v", linewidth=LineWidth, label='HM')

        bpp, psnr, msssim = [0.040126953125, 0.0186281368371212, 0.0107635830965909, 0.00678400213068181], [39.6195622916334, 38.5596286637383, 37.4673416251289, 36.2411065323369], [0.986225628548472, 0.983885645866589, 0.980787111590201, 0.976344241308878]
        VTM, = plt.plot(bpp, psnr, "b--v", linewidth=LineWidth, label='VTM')
    else:
    ...
    if not os.path.exists(prefix):
        os.makedirs(prefix)    
    if hclass != 'E':
        plt.legend(handles=[HM, VTM, DVC, DVCp, RY, Liu, LU, RaFC, FVC, DCVC, C2F], loc=4)
    else:
        plt.legend(handles=[HM, VTM, DVC, DVCp, Liu, LU, RaFC, FVC, DCVC, C2F], loc=4)
    ...
    if hclass == 'B':
        ...
        bpp, psnr, msssim = [0.346251, 0.171096, 0.083922, 0.048822], [35.094989, 34.15273, 32.851167, 31.621055], [0.985658, 0.979081, 0.970988, 0.963175]
        ...
        bpp, psnr, msssim = [0.276507, 0.169406, 0.105082, 0.068137], [30.600426, 29.706243, 28.144982, 26.99063], [0.987859, 0.982535, 0.972749, 0.961119]
        C2F, = plt.plot(bpp, msssim, "y-o", color="indigo", linewidth=LineWidth, label='C2F')
        ...
        bpp, psnr, msssim = [0.215273, 0.139088, 0.088783, 0.059608], [29.432105, 28.702353, 27.06424, 25.58261], [0.989656, 0.985264, 0.976299, 0.964831]
        C2F, = plt.plot(bpp, msssim, "y-o", color="indigo", linewidth=LineWidth, label='C2F')
        ...
        bpp, psnr, msssim = [0.104279, 0.044741, 0.022619, 0.013469], [37.767025, 36.68654, 35.340456, 34.086686], [0.991712, 0.988991, 0.985737, 0.982283]
        C2F, = plt.plot(bpp, msssim, "y-o", color="indigo", linewidth=LineWidth, label='C2F')
